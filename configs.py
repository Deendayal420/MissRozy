...
class Config(object):
	...
	BOT_TOKEN = os.environ.get("BOT_TOKEN","6957743631:AAH9daSQtkKdNzX5X0hZFCsi7uOfeif4Ov0")
	BOT_USERNAME = os.environ.get("BOT_USERNAME" , "@Deendayal_File_Store_Bot")
	DB_CHANNEL = int(os.environ.get("DB_CHANNEL", -1002007902603))
	BOT_OWNER = int(os.environ.get("BOT_OWNER", "6646028262"))
	DATABASE_URL = os.environ.get("DATABASE_URL","mongodb+srv://deendayaldhaked73:ELOk7qZAoShVO5h4@cluster0.90168hk.mongodb.net/?retryWrites=true&w=majority")
	UPDATES_CHANNEL = os.environ.get("UPDATES_CHANNEL", "-1001786865459")
	LOG_CHANNEL = os.environ.get("LOG_CHANNEL", "-1002007902603")
